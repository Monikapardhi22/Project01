   ...
   <div>
      ...
      <div className='flex font-bold text-white '>
        ...
        <div className=' flex flex-row gap-3'>
            <a href='/' className='border-[1px] w-[70px] h-[40px] text-center border-solid border-gray-400 rounded-[2px]  gap-4  flex justify-center items-center font-bold text-white  overflow-hidden mt-1.5 p-1 mr-1 ml-1 hover:border-red-500 hover:border-2 hover:text-red-500 text-[15px]'>Back</a>
